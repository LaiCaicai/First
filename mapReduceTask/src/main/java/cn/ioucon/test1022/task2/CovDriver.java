...
public class CovDriver {
    public static void main(String[] args) throws IllegalArgumentException, IOException, ClassNotFoundException, InterruptedException {
        ...
        args = new String[] { "F:\\mapreduce-and-spark-master\\mapreduce\\mapReduceTask\\src\\main\\resources\\test1022\\input\\(日期、县、州、县编码、累计确诊病例、累计死亡病例).txt", "F:\\mapreduce-and-spark-master\\mapreduce\\mapReduceTask\\src\\main\\resources\\test1022\\task2\\output" };
        ...
        job.setMapOutputValueClass(cn.ioucon.test1022.task2.CovBean.class);
        // 4 指定最终输出的数据的 kv 类型
